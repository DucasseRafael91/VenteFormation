...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 11 déc. 2025 à 07:48
...
--
-- Structure de la table `g_personnage`
--

DROP TABLE IF EXISTS `g_personnage`;
CREATE TABLE IF NOT EXISTS `g_personnage` (
...
--
-- Déchargement des données de la table `g_personnage`
--

INSERT INTO `g_personnage` (`p_id`, `p_nom`, `p_fk_livre_isbn`) VALUES
...
INSERT INTO `g_selection` (`s_id`, `s_nom`) VALUES
(1, '1ere Selection'),
(2, '2eme Selection'),
(3, '3eme Selection'),
(4, 'Laureat');
...
--
-- Déchargement des données de la table `g_selection_livre`
--

INSERT INTO `g_selection_livre` (`s_fk_selection_id`, `s_fk_livre_isbn`, `s_nbr_votes`) VALUES
(1, '	 9782823623376', 2),
(1, '9782021603439', 5),
(1, '9782073080028', 3),
(1, '9782073101228', 1),
...
--
-- Contraintes pour la table `g_personnage`
--
ALTER TABLE `g_personnage`
  ADD CONSTRAINT `g_personnage_ibfk_1` FOREIGN KEY (`p_fk_livre_isbn`) REFERENCES `g_livre` (`l_isbn`) ON DELETE RESTRICT ON UPDATE RESTRICT;
